...
private _reporterContext = createHashmapFromArray [["_componentName","Set-No Expiry"]];
...
Dev_testHandle = [_fnc_reporter,_reporterContext] spawn {
    ...
    //// Assert
    ["SomeTestVariable", "SomeAnswerVariable", 1e39, {hint "Goodbye World"}] call CaSe_fnc_keyCache_set;
    ...
    private _checks = [
        ...
        ["excludedFromGC", !("SomeTestVariable" in GETP(GC_registeredItems))]
    ];
