...
Example:
    ...
    [[3463463] call CaSe_fnc_timeSpan_fromSeconds] call CaSe_fnc_timeSpan_format;  // ~"40 Days 2 Hours 4 Minutes 23 Seconds"

    ([[serverTime] call CaSe_fnc_timeSpan_fromSeconds] call CaSe_fnc_timeSpan_format) + " since mission started.";  // ~ "9 Hours 30 Minutes 9 Seconds 812 Milliseconds 499 Microseconds 961 Nanoseconds since mission started."
*/
params [
    ["_secondsIn",0,[ 0 ]]
];
